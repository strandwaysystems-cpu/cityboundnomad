...
> its own stays at `verified: false`. The reason *is* the entry — the most
> useful line in the whole round ("the Hi Loft happy hour is open to non-guests")
> came out of an aside, not out of a list of names.
